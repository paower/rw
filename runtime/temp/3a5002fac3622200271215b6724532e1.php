<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:41:"./shop/admin\view\auth_manager\index.html";i:1547203759;s:45:"D:\web\mshop\shop\admin\view\public\base.html";i:1562121180;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="page-header">
	<a href="<?php echo url('AuthManager/create_group'); ?>" class="btn btn-primary">新增用户组</a>
</div>		
	...
	<div class="col-xs-12">	
		<div class="table-responsive">
			<table class="table table-striped table-bordered table-hover">
				...
				<tbody>
						<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i;?>
						<tr>													
							<td>
								<a href='<?php echo url("AuthManager/edit_group",array("id"=>$d["id"])); ?>'>
									<?php echo $d['title']; ?>
								</a> 
							</td>
							<td><?php echo $d['description']; ?></td>
							<td>
								<a href='<?php echo url("AuthManager/access",array("id"=>$d["id"])); ?>'>
									访问授权
								</a> 
							</td>
							<td>							
							<?php switch($d['status']): case "1": ?><a href='<?php echo url("AuthManager/set_status",array("id"=>$d["id"],"status"=>0)); ?>'><span class="btn btn-xs btn-success"><i class="fa fa-check bigger-120"></i></span></a><?php break; case "0": ?><a href='<?php echo url("AuthManager/set_status",array("id"=>$d["id"],"status"=>1)); ?>'><span class="btn btn-xs btn-danger"><i class="fa fa-remove bigger-120"></i></span></a><?php break; endswitch; ?>
								
							</td>
							<td>
								
								<a class="delete btn btn-xs btn-danger" href='<?php echo url("AuthManager/del_group",array("id"=>$d["id"])); ?>' >
