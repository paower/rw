<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:32:"./shop/admin\view\user\edit.html";i:1547203759;s:45:"D:\web\mshop\shop\admin\view\public\base.html";i:1562121180;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="row">
	<div class="col-xs-12">	
		<div class="form-horizontal">
			...
			<input name="admin_id" type="hidden" value="<?php echo \think\Request::instance()->param('id'); ?>" />
			<?php endif; ?>			
					
			<div class="form-group required">
				<label class="col-sm-2 control-label">用户名：</label>
				<div class="col-sm-10">
					<input  class="form-control" type="text" placeholder="用户名" name="user_name"  value="<?php echo (isset($user['user_name']) && ($user['user_name'] !== '')?$user['user_name']:''); ?>" />
				</div>
			</div>			
			...
			<div class="form-group required">
				...
				<div class="col-sm-10">
					<input  class="form-control" type="text" placeholder="密码" name="passwd"  value="888888" />
				</div>
			</div>
			...
			<div class="form-group required">
				...
				<div class="col-sm-10">
					<input  class="form-control" type="text" placeholder="真实姓名" name="true_name"  value="<?php echo (isset($user['true_name']) && ($user['true_name'] !== '')?$user['true_name']:''); ?>" />
				</div>
			</div>
			...
			<div class="form-group required">
				...
				<div class="col-sm-10">
					<input  class="form-control" type="text" placeholder="手机号码" name="telephone"  value="<?php echo (isset($user['telephone']) && ($user['telephone'] !== '')?$user['telephone']:''); ?>" />
				</div>
			</div>
			...
			<div class="form-group required">
				...
				<div class="col-sm-10">
					<select class="form-control" name="group_id">
						...
						<option <?php if(isset($user) and ($user['group_id'] == $g['id'])): ?> selected="selected"<?php endif; ?>  value="<?php echo $g['id']; ?>"><?php echo $g['title']; ?></option>		
						<?php endforeach; endif; else: echo "" ;endif; ?>				
					</select>
				</div>
			</div>
...
var back_index="<?php echo url('User/index'); ?>";

$('#send').click(function(){
	$.post(
		'<?php echo $action; ?>',
		$('.form-horizontal input[type=\'text\'],.form-horizontal input[type=\'hidden\'],.form-horizontal select,.form-horizontal input[type=\'radio\']:checked'),
		function(d){
...
$(function(){
	Oscshop.setValue("status", <?php echo (isset($user['status']) && ($user['status'] !== '')?$user['status']:'1'); ?>);
});
</script>							
