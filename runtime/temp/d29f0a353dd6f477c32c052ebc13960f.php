<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:35:"./shop/admin\view\coupon\index.html";i:1562914639;s:34:"./shop/admin/view/public/base.html";i:1562121180;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="page-header">	
	<a href="<?php echo url('Coupon/add'); ?>" class="btn btn-primary">新增</a>
</div>		
<table class="table table-striped table-bordered table-hover search-form">
	<thead>
		
		<th><input name="coupon_name" type="text" placeholder="输入优惠券名称" value="<?php echo input('param.coupon_name'); ?>" /></th>		
		
		<th>
			<a class="btn btn-primary" href="javascript:;" id="search" url="<?php echo url('Coupon/index'); ?>">查询</a>
		</th>
	</thead>
</table>	
			...
			<table class="table table-striped table-bordered table-hover">
				...
				<tbody>
						...
						<tr>						
							...
							<td><?php echo $v['conpon_prefix']; ?></td>
							<td><?php echo $v['coupon_name']; ?></td>
							<td>
								<?php if($v['coupon_type'] == 1): ?>
									满减
								<?php else: ?>
									折扣
								<?php endif; ?>
							...
							<td>
								<?php if($v['coupon_limit'] != 0): ?>
									¥<?php echo $v['coupon_limit']; else: ?>
									无
								<?php endif; ?>
							</td>
							<td>
								<?php if($v['coupon_type'] == 1): ?>
									¥<?php echo $v['coupon_value']; else: ?>
									<?php echo $v['coupon_value']; ?>折
								<?php endif; ?>
							</td>
							<td><?php echo $v['coupon_num']; ?></td>
							<td><?php echo $v['coupon_num'] - $v['coupon_surplus_num']; ?></td>
							<td><?php echo $v['describe']; ?></td>
							<td><?php echo $v['term']; ?></td>
							<td><?php echo date("y-m-d H:i:s",$v['generate_time']); ?></td>
							<td>
								<a  class="btn btn-xs btn-info" href='<?php echo url("Coupon/edit",array("id"=>$v["coupon_id"])); ?>'>
									<i class="fa fa-edit bigger-120"></i>
								</a> 
								
								<!-- <a class="delete btn btn-xs btn-danger" href='<?php echo url("Coupon/del",array("id"=>$v["coupon_id"])); ?>' >
