<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:40:"./shop/admin\view\settings\frontend.html";i:1563001797;s:45:"D:\web\mshop\shop\admin\view\public\base.html";i:1562121180;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
	...
	<div class="col-xs-12">
		<div class="form-horizontal">
			...
			<table id="images" class="table table-striped table-bordered table-hover">
				...
				<tbody>
					<?php $image_row = 0; if(isset($frontend_images)){ foreach ($frontend_images as $goods_image) { ?>
...
<script>
	...
	function addImage() {
		...
		html += '  <td class="text-left"><a href="#" id="thumb-image' + image_row +
			'"data-toggle="image" class="img-thumbnail"><img src="/public/static/image/no_image_100x100.jpg" /><input type="hidden" name="frontend_images[' +
	...
	$('.save').live('click', function() {
		...
		$.post(
			"<?php echo url('Settings/ajax_eidt'); ?>",
	...
	$('.del').live('click', function() {
		...
		$.post(
			"<?php echo url('Settings/ajax_del'); ?>",
