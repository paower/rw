<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:41:"./themes/default/member/finance\show.html";i:1562643009;s:34:"./shop/admin/view/public/base.html";i:1562121180;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<?php use think\Db; ?>
	...
	<ul class="nav nav-tabs">
	  ...
	  <li class="active"><a href="#tab-order" data-toggle="tab">详情</a></li>
	</ul>
	<div class="tab-content">
		<div class="tab-pane active" id="tab-order">
			<table class="table table-bordered">
				...
				<tr>
					<td>会员账号(手机号)</td>
					<td><?php echo $finance['user_phone']; ?></td>
				</tr>
				<tr>
		            <td>会员名称</td>
		            <td>
		            	<?php echo $finance['user_name']; ?>
		            </td>
		         </tr>
				<tr>
					<td>会员银行名称</td>
					<td>					
						<?php echo $finance['bank_name']; ?>
					</td>
				</tr>
				<tr>
				    <td>会员支行名称</td>
				    <td><?php echo $finance['bank_name2']; ?></td>
				</tr>
				  <tr>
				    <td>会员银行开户人</td>
				    <td><?php echo $finance['bank_user']; ?></td>
				</tr> 
				<tr>
				    <td>会员银行卡号</td>
				    <td>
				    	<?php echo $finance['bank_num']; ?>
				    </td>
				</tr>
				<tr>
				    <td>类型</td>
				...
				<tr>
				    <td>状态</td>
				    <td>
				    	<?php if($finance['state'] == 1): ?>
							待审核
						<?php elseif($finance['state'] == 2): ?>
							已完成
						<?php elseif($finance['state'] == 3): ?>
							已取消
						<?php endif; ?>
				    </td>
				</tr>     
				<tr>
					<td>金额</td>
					<td>¥<?php echo $finance['price']; ?></td>
				</tr>  
				<tr>
					<td>生成时间</td>
					<td><?php echo date('Y/m/d H:i:s',$finance['creation_time']); ?></td>
				</tr>
				<tr>
					<td>完成时间</td>
					<td>
						<?php if($finance['complete_time'] == ''): ?>
							无
						<?php else: ?>
							<?php echo date('Y/m/d H:i:s',$finance['complete_time']); endif; ?>
					</td>
				</tr>
				<tr>
					<td>凭证</td>
					<td>
						<?php if($finance['voucher'] == ''): ?>
							无
						<?php else: ?>
							<img src="/public/uploads/<?php echo $finance['voucher']; ?>" />
						<?php endif; ?>
					</td>
				</tr>
				</table>
