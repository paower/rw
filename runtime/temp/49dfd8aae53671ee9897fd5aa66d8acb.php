<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:33:"./shop/admin\view\user\index.html";i:1547203759;s:45:"D:\web\mshop\shop\admin\view\public\base.html";i:1562121180;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="page-header">
	<a href="<?php echo url('User/add'); ?>" class="btn btn-primary">新增</a>
</div>		
			...
			<table class="table table-striped table-bordered table-hover">
				...
				<tbody>
						...
						<tr>							
							...
							<td>
								<?php switch($a['status']): case "1": ?><a href='<?php echo url("User/set_status",array("id"=>$a["admin_id"],"status"=>0)); ?>'><span class="btn btn-xs btn-success"><i class="fa fa-check bigger-120"></i></span></a><?php break; case "0": ?><a href='<?php echo url("User/set_status",array("id"=>$a["admin_id"],"status"=>1)); ?>'><span class="btn btn-xs btn-danger"><i class="fa fa-remove bigger-120"></i></span></a><?php break; endswitch; ?>								
							</td>							
							<td>
								<a  class="btn btn-xs btn-info" href='<?php echo url("User/edit",array("id"=>$a["admin_id"])); ?>'>
									<i class="fa fa-edit bigger-120"></i>
								</a> 
								<a class="delete btn btn-xs btn-danger" href='<?php echo url("User/del",array("id"=>$a["admin_id"])); ?>' >
						...
						<tr>
							<td colspan="20">总计 <?php echo ($list->total() ?: "0"); ?> 个用户</td>
						</tr>
				</tbody>
