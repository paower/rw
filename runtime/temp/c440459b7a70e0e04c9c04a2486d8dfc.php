<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:37:"./shop/common/view/public/success.tpl";i:1547203759;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <style type="text/css">
    	*{
		...
		.error_cont{
			...
			background:url(/public/static/image/success.gif) 32px 32px no-repeat;
			line-height:1.8;
		}
		.error_return{
			padding:10px 0 0 0;
		...
		.btn {
			color: #333;
			background:#e6e6e6 url(/public/static/image/btn.png);
