<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:48:"./themes/default/member/order_backend\index.html";i:1562744733;s:34:"./shop/admin/view/public/base.html";i:1562121180;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
						...
						<tr>						
							...
							<td>
								...
								<?php if($v['order_status_id'] == 1): ?>
									<a  class="delete btn btn-xs btn-info" href='<?php echo url("OrderBackend/updateOrder",array("id"=>$v["order_id"],"type"=>4)); ?>'>
										<i class="fa fa-play-circle-o bigger-120"></i>
									</a> 
									<a  class="delete btn btn-xs btn-info" href='<?php echo url("OrderBackend/updateOrder",array("id"=>$v["order_id"],"type"=>5)); ?>'>
										<i class="fa fa-remove bigger-120"></i>
									</a> 	
								<?php endif; if($v['order_status_id'] == 4): ?>
									<a  class="delete btn btn-xs btn-info" href='<?php echo url("OrderBackend/updateOrder",array("id"=>$v["order_id"],"type"=>6)); ?>'>
										<i class="fa fa-check bigger-120"></i>
									</a> 
								<?php endif; if($v['order_status_id'] == 7): ?>
									<a  class="delete btn btn-xs btn-info" href='<?php echo url("OrderBackend/updateOrder",array("id"=>$v["order_id"],"type"=>5)); ?>'>
										<i class="fa fa-remove bigger-120"></i>
									</a> 
								<?php endif; if($v['shipping_method']): ?>
