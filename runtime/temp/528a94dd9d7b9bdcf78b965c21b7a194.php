<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:35:"./shop/admin\view\config\index.html";i:1547203759;s:45:"D:\web\mshop\shop\admin\view\public\base.html";i:1562121180;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="page-header">
	<a href="<?php echo url('Config/add'); ?>" class="btn btn-primary">新增</a>
</div>		
	
<table class="table table-striped table-bordered table-hover search-form">
	<thead>
		<th><input name="name" type="text" placeholder="输入配置名称" value="<?php echo input('name'); ?>" /></th>
		<th>    				
			<select name="module">
				<option value="">-所有分组-</option>
				
				<?php if(is_array($module) || $module instanceof \think\Collection || $module instanceof \think\Paginator): $i = 0; $__LIST__ = $module;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$config): $mod = ($i % 2 );++$i;?>
					<option <?php if(input('module') == $config['module']): ?> selected="selected"<?php endif; ?> value="<?php echo $config['module']; ?>"><?php echo $config['module_name']; ?></option>
				<?php endforeach; endif; else: echo "" ;endif; ?>
		...
		<th>
			<a class="btn btn-primary" href="javascript:;" id="search" url="<?php echo url('Config/index'); ?>">查询</a>
		</th>
	</thead>
</table>	
	...
	<div class="col-xs-12">	
		<div class="table-responsive">
			<table class="table table-striped table-bordered table-hover">
				...
				<tbody>
						<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$c): $mod = ($i % 2 );++$i;?>
						<tr>							
							<td><?php echo $c['name']; ?></td>
							<td><?php echo $c['module_name']; ?></td>
							<td><?php echo $c['value']; ?></td>		
							<td><?php echo $c['info']; ?></td>						
							<td>
								<a  class="btn btn-xs btn-info" href='<?php echo url("Config/edit",array("id"=>$c["id"])); ?>'>
									<i class="fa fa-edit bigger-120"></i>
								</a> 
								<a class="delete btn btn-xs btn-danger" href='<?php echo url("Config/del",array("id"=>$c["id"])); ?>' >
						...
						<tr>
							<td colspan="20">总计 <?php echo ($list->total() ?: "0"); ?> 个配置</td>
						</tr>
				</tbody>
