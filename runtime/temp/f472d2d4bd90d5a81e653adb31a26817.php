<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:48:"./themes/default/index/setting\set_security.html";i:1562897704;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<title>安全密码</title>
      ...
      <div class="index-bigbox" style="margin-top: 0px;">
		  ...
		  <?php if($boolean): ?>
			  <div class="personal-box5" style="background-image: none;">
				  <input id="old_password" name="old_password" type="password" placeholder="当前安全密码" />
			  </div>
		  <?php endif; ?>
          <div class="personal-box5" style="background-image: none;">
          	  <input id="new_password" name="new_password" type="password" placeholder="新安全密码" />
          </div>
		  <div class="personal-box5" style="background-image: none;">
...
<script>
	function sub(){
		...
		$.ajax({
			url: "<?php echo url('Setting/setSecurity'); ?>",
			type: 'POST',
