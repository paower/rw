<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:37:"./shop/admin\view\settings\other.html";i:1562997254;s:45:"D:\web\mshop\shop\admin\view\public\base.html";i:1562121180;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="row">
	<div class="col-xs-12">
		<div class="form-horizontal">
				...
				<div class="col-sm-10">
					<div class="clearfix">
						<select class="form-control" name="default_order_status_id">
							...
							<option <?php if($status['order_status_id'] == config('default_order_status_id')): ?> selected="selected" <?php endif; ?>
				...
				<div class="col-sm-10">
					<div class="clearfix">
						<select class="form-control" name="paid_order_status_id">
							<?php if(is_array($order_status) || $order_status instanceof \think\Collection || $order_status instanceof \think\Paginator): $i = 0; $__LIST__ = $order_status;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$status): $mod = ($i % 2 );++$i;?>
							<option <?php if($status['order_status_id'] == config('paid_order_status_id')): ?> selected="selected" <?php endif; ?>
							 value="<?php echo $status['order_status_id']; ?>"><?php echo $status['name']; ?></option>
							<?php endforeach; endif; else: echo "" ;endif; ?>
						</select>
					</div>
				...
				<div class="col-sm-10">
					<div class="clearfix">
						<select class="form-control" name="complete_order_status_id">
							<?php if(is_array($order_status) || $order_status instanceof \think\Collection || $order_status instanceof \think\Paginator): $i = 0; $__LIST__ = $order_status;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$status): $mod = ($i % 2 );++$i;?>
							<option <?php if($status['order_status_id'] == config('complete_order_status_id')): ?> selected="selected"
							 <?php endif; ?> value="<?php echo $status['order_status_id']; ?>"><?php echo $status['name']; ?></option>
							<?php endforeach; endif; else: echo "" ;endif; ?>
						</select>
					</div>
				</div>
				...
				<div class="col-sm-10">
					<div class="clearfix">
						<select class="form-control" name="cancel_order_status_id">
							<?php if(is_array($order_status) || $order_status instanceof \think\Collection || $order_status instanceof \think\Paginator): $i = 0; $__LIST__ = $order_status;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$status): $mod = ($i % 2 );++$i;?>
							<option <?php if($status['order_status_id'] == config('cancel_order_status_id')): ?> selected="selected" <?php endif; ?>
							 value="<?php echo $status['order_status_id']; ?>"><?php echo $status['name']; ?></option>
							<?php endforeach; endif; else: echo "" ;endif; ?>
						</select>
					</div>
			...
			<legend>平台参数 </legend>
			<div class="form-group">
				<label class="col-sm-2 control-label no-padding-left">开户银行 </label>
				<div class="col-sm-10">
					<div class="clearfix">
						<input class="col-xs-10 col-sm-10 form-control" name="bank_name" type="text" value="<?php echo $bank_name; ?>">
					</div>
				</div>
			</div>

			<div class="form-group">
				<label class="col-sm-2 control-label no-padding-left">开户支行 </label>
				<div class="col-sm-10">
					<div class="clearfix">
						<input class="col-xs-10 col-sm-10 form-control" name="bank_name2" type="text" value="<?php echo $bank_name2; ?>">
					</div>
				</div>
			</div>

			<div class="form-group">
				<label class="col-sm-2 control-label no-padding-left">开户姓名 </label>
				<div class="col-sm-10">
					<div class="clearfix">
						<input class="col-xs-10 col-sm-10 form-control" name="bank_user" type="text" value="<?php echo $bank_user; ?>">
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<div class="clearfix">
						<input class="col-xs-10 col-sm-10 form-control" name="bank_num" type="text" value="<?php echo $bank_num; ?>">
					</div>
				</div>
			</div>

			<div class="form-group">
				<label class="col-sm-2 control-label no-padding-left">会员购物返现时间（天） </label>
				<div class="col-sm-10">
					<div class="clearfix">
						<input class="col-xs-10 col-sm-10 form-control" name="return_day" type="number" value="<?php echo $return_day; ?>">
					</div>
				</div>
			</div>
		</div>
