<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:40:"./shop/admin\view\user_action\index.html";i:1547203759;s:45:"D:\web\mshop\shop\admin\view\public\base.html";i:1562121180;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
	...
	<div class="col-xs-12">	
		<div class="table-responsive">
			<table class="table table-striped table-bordered table-hover">
				...
				<tbody>
						<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$ua): $mod = ($i % 2 );++$i;?>
						<tr>							
							<td><?php echo $ua['uname']; ?></td>
							<td><?php echo $ua['type']; ?></td>
							<td><?php echo $ua['info']; ?></td>							
							<td><?php echo date("Y-m-d H:i:s",$ua['add_time']); ?></td>							
						</tr>
