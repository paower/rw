<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:37:"./shop/admin\view\category\index.html";i:1547203759;s:45:"D:\web\mshop\shop\admin\view\public\base.html";i:1562121180;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="page-header">
	<?php if(\think\Request::instance()->param('pid')): ?>
		<a href="<?php echo url('Category/add',array('pid'=>input('param.pid'))); ?>" class="btn btn-primary">新增</a>
	<?php else: ?>
		<a href="<?php echo url('Category/add'); ?>" class="btn btn-primary">新增</a>
	<?php endif; ?>
</div>	
