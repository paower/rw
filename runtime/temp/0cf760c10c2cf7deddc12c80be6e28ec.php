<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"./themes/default/member/order_status\index.html";i:1561701883;s:34:"./shop/admin/view/public/base.html";i:1562121180;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="page-header">
	<a href="<?php echo url('order_status/add'); ?>" class="btn btn-primary">新增</a>
</div>	
			...
			<table class="table table-striped table-bordered table-hover">
				...
				<tbody>
						...
						<tr>
							...
							<td>
								<a  class="btn btn-xs btn-info" href='<?php echo url("order_status/edit",array("id"=>$data["order_status_id"])); ?>'>
									<i class="fa fa-edit bigger-120"></i>
								</a> 
								<a class="delete btn btn-xs btn-danger" href='<?php echo url("order_status/del",array("id"=>$data["order_status_id"])); ?>' >
