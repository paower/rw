<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"./themes/default/member/order_status\edit.html";i:1561701883;s:34:"./shop/admin/view/public/base.html";i:1562121180;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="row">
	<div class="col-xs-12">	
		...
		<div class="form-horizontal">
			...
			<input name="order_status_id" type="hidden" value="<?php echo \think\Request::instance()->param('id'); ?>" />
			<?php endif; ?>
			...
			<div class="col-sm-11">
				<div class="clearfix">
				<input name="name" id="title" class="col-xs-10 col-sm-5"  value="<?php echo (isset($d['name']) && ($d['name'] !== '')?$d['name']:''); ?>" type="text">
				</div>
			</div>
			</div>
...
var back_index="<?php echo url('order_status/index'); ?>";
